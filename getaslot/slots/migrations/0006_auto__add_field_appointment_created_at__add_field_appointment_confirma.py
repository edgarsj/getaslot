...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Appointment.created_at'
        db.add_column('slots_appointment', 'created_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now), keep_default=False)

        # Adding field 'Appointment.confirmation_sent'
        db.add_column('slots_appointment', 'confirmation_sent', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Appointment.created_at'
        db.delete_column('slots_appointment', 'created_at')

        # Deleting field 'Appointment.confirmation_sent'
        db.delete_column('slots_appointment', 'confirmation_sent')
