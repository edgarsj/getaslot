...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'WorkSchedule.day'
        db.add_column('slots_workschedule', 'day', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)

        # Adding field 'Appointment.day'
        db.add_column('slots_appointment', 'day', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)

        # Adding field 'Appointment.reminder_sent'
        db.add_column('slots_appointment', 'reminder_sent', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'WorkSchedule.day'
        db.delete_column('slots_workschedule', 'day')

        # Deleting field 'Appointment.day'
        db.delete_column('slots_appointment', 'day')

        # Deleting field 'Appointment.reminder_sent'
        db.delete_column('slots_appointment', 'reminder_sent')
    ...
    models = {
        ...
        'slots.appointment': {
            'Meta': {'ordering': "['-endtime']", 'object_name': 'Appointment'},
